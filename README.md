...
| Skill                                                           | Description                                                                                                                                                                                          |
| --------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [prototyping](/skills/prototyping/SKILL.md)                     | Scaffold and deploy password-protected ART+COM web prototypes with GitLab, Netlify, and optional MQTT support                                                                                        |
| [mqtt-topping](/skills/mqtt-topping/SKILL.md)                   | Connect to MQTT brokers, subscribe/publish messages, and query retained data over HTTP using [mqtt-topping](https://github.com/artcom/mqtt-topping), plus its React hooks wrapper                    |
...
| [figma-visual-parity](/skills/figma-visual-parity/SKILL.md)     | Verify a rendered screen against its Figma export with the `figma-visual-parity` CLI — a pass/fail gate plus a ranked diagnosis (font-metrics mismatch, uniform offset, DOM-attributed hotspots) instead of a bare pixel-diff percentage |
